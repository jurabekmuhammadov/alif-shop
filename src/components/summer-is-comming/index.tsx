    ...
    return (
        <div className='mt-8'>
            <div className='mb-4 flex items-center justify-between md:justify-start md:gap-5'>
                <h1 className='text-xl font-semibold text-gray-900 md:text-2xl lg:text-3xl'>Yoz kelmoqda</h1>
...
export default SummerIsComming